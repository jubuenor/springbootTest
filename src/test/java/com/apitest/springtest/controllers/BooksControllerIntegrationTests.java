...
public class BooksControllerIntegrationTests {
  ...
  @Autowired
  public BooksControllerIntegrationTests(MockMvc mockMvc,
  ...
  public void testThatCreateBookReturnsHttpStatus201Created() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.put("/books/978-1-2345-6789-0")
  ...
  public void testThatListBooksReturnsHttpStatus200Ok() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.get("/books").contentType(
  ...
  @Test
  public void testThatGetBookReturnsHttpStatus200OkWhenBookExists()
      throws Exception {
    BookEntity testBookEntityA = TestDataUtil.createTestBookEntityA(null);
    bookService.createBook(testBookEntityA.getIsbn(), testBookEntityA);
  ...
  @Test
  public void testThatGetBookReturnsHttpStatus404WhenBookDoesntExist()
      throws Exception {
    BookEntity testBookEntityA = TestDataUtil.createTestBookEntityA(null);
    mockMvc
        .perform(
  ...
  @Test
  public void testThatDeleteNonExistingBookReturnsHttpStatus404NoContent()
      throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.delete("/books/kjsbdfjdfsk")
                     .contentType(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isNotFound());
  }

  @Test
  public void testThatDeleteExistingBookReturnsHttpStatus200NoContent()
      throws Exception {
    BookEntity testBookEntityA = TestDataUtil.createTestBookEntityA(null);
    bookService.createBook(testBookEntityA.getIsbn(), testBookEntityA);
